        ...
        <div class="card card-custom-bg text-white" style="border-radius: 1rem;">
          <div class="card-body ">
            <div class="mb-md-5 mt-md-4 ">
              ...
              <p class="text-dark mb-5 fw-bold text-center">Teacher Registeration</p>
              <form action="teacher_registeration.php" method="POST">
                <div class="form-outline form-white mb-4">
                  ...
                  <input id="radio1" name="role" type="radio" checked="checked" value="teacher" ><label for=radio1> .</label><br>
