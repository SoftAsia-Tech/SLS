...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <?php include 'student_dashboard_sidebar.php'; ?>
        <!--/span-->
                    ...
                    <div class="block-content collapse in">
                        <div class="span12">
                            ...
                            <div class="span3">
                                ...
                                <div class="chart-bottom-heading"><strong>Registered Teacher</stron>
                                </div>
                            </div>
                            ...
                            <div class="span3">
                                ...
                                <div class="chart-bottom-heading"><strong>Teachers</stron>
                                </div>
                            </div>
                            ...
                            <div class="span3">
                                ...
                                <div class="chart-bottom-heading"><strong>Registered Students</stron>
                                </div>
                            </div>
                            ...
                            <div class="span3">
                                <div class="chart" data-percent="<?php echo $count_student ?>"><?php echo $count_student ?></div>
                                <div class="chart-bottom-heading"><strong>Students</stron>
                                </div>
                            </div>
                            ...
                            <div class="span3">
                                ...
                                <div class="chart-bottom-heading"><strong>Class</stron>
                                </div>
                            </div>
                            ...
                            <div class="span3">
                                ...
                                <div class="chart-bottom-heading"><strong>Downloadable File</stron>
                                </div>
                            </div>
                            ...
                            <div class="span3">
                                ...
                                <div class="chart-bottom-heading"><strong>Subjects</stron>
                                </div>
                            </div>
